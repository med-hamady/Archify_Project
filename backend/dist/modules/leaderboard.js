 ...
 */
exports.leaderboardRouter.get('/global', auth_1.requireAuth, async (req, res) => {
    try {
 ...
 */
exports.leaderboardRouter.get('/subject/:subjectId', auth_1.requireAuth, async (req, res) => {
    try {
 ...
 */
exports.leaderboardRouter.get('/my-rank', auth_1.requireAuth, async (req, res) => {
    try {
