...
exports.canAccessVideo = canAccessVideo;
exports.canAccessDocument = canAccessDocument;
exports.checkLessonAccess = checkLessonAccess;
exports.checkVideoFileAccess = checkVideoFileAccess;
 ...
 */
async function canAccessVideo(userId, lessonId) {
 ...
 * With PREMIUM subscription, user has access to all content
 */
async function canAccessDocument(userId, lessonId) {
    const { hasSubscription, subscriptionType } = await hasActiveSubscription(userId);
    if (!hasSubscription) {
        return false;
    }
