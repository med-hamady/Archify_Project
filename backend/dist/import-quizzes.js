 ...
 */
async function importSubjectQuizzes(subjectTitle, semester, quizFilesPath, description) {
...
async function main() {
    ...
    try {
        ...
        console.log('═══════════════════════════════════════');
        await importSubjectQuizzes('Anatomie', 'PCEM1', path.join(baseDir, 'pcem1', 'anatomie'), 'Anatomie du membre supérieur et inférieur');
        await importSubjectQuizzes('Histologie', 'PCEM1', path.join(baseDir, 'pcem1', 'histo'), 'Histologie des tissus et organes');
        await importSubjectQuizzes('Physiologie', 'PCEM1', path.join(baseDir, 'pcem1', 'physio'), 'Physiologie cellulaire et des systèmes');
        // ===== PCEM2 - S International =====
        console.log('\n═══════════════════════════════════════');
        console.log('📖 PCEM2 - S International');
        console.log('═══════════════════════════════════════');
        await importSubjectQuizzes('Anatomie', 'PCEM2', path.join(baseDir, 'pcem2', 'anatomie'), 'Anatomie niveau PCEM2');
        await importSubjectQuizzes('Histologie', 'PCEM2', path.join(baseDir, 'pcem2', 'histo'), 'Histologie niveau PCEM2');
        await importSubjectQuizzes('Physiologie', 'PCEM2', path.join(baseDir, 'pcem2', 'physio'), 'Physiologie niveau PCEM2');
        console.log('\n═══════════════════════════════════════');
...
//# sourceMappingURL=import-quizzes.js.map