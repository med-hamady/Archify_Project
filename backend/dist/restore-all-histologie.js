...
async function restoreAll() {
    ...
    try {
        ...
        try {
            (0, child_process_1.execSync)('node dist/import-histologie-pcem2.js', { stdio: 'inherit', cwd: __dirname + '/..' });
        ...
        try {
            (0, child_process_1.execSync)('node dist/import-histo-nozha-pcem2.js', { stdio: 'inherit', cwd: __dirname + '/..' });
...
//# sourceMappingURL=restore-all-histologie.js.map